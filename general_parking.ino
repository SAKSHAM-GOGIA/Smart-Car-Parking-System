...
#include "Adafruit_MQTT.h"
#include "Adafruit_MQTT_Client.h"
const char *ssid = "Sumit's Galaxy A73 5G"; // Enter your WiFi Name
const char *pass = "anand123";              // Enter your WiFi Password
#define MQTT_SERV "io.adafruit.com"
#define MQTT_PORT 1883
#define MQTT_NAME "anandsumit"
#define MQTT_PASS "aio_Egya79aqSRXsL6fEaFUTVyly2Eo3"
WiFiUDP ntpUDP;
NTPClient timeClient(ntpUDP, "pool.ntp.org", 19800, 60000);
Servo myservo;  // servo as gate // exit servo
//Servo myservos; // servo as gate // entry servo

int carEnter = D0;  // entry sensor
int carExited = D8; // exit sensor
//int slot3 = D7;
int slot2 = D6;
int slot1 = D3;
int count = 0;
...
void loop()
{
    ...
    Serial.print("Entry Sensor Value: ");
    Serial.println(entrysensor);
    Serial.print("Exit Sensor Value: ");
        Serial.println(exitsensor);
    if (entrysensor == 1) // if high then count and send data
    {
        ...
        {
            Serial.println("Max cars Parked");
            count = 2;
        }
    }
